...
> Поточна MiniLM це демо-заміна: вона легка й багатомовна, але для косметичної
> термінології варто порівняти її з `bge-m3` або `multilingual-e5-large`,
> які ми вже використовуємо в інших проєктах.
