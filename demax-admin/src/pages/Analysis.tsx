        ...
        <Card className="animate-rise-2 lg:col-span-3">
          ...
          <ul className="space-y-3 text-sm leading-relaxed text-ink-600 dark:text-ink-300">
            {([
              ...
              { uk: 'Команда без накладних витрат: двоє senior-інженерів, пряма комунікація із замовником, нульова бюрократія — за архітектуру, код і реліз відповідають ті самі люди, без прошарку менеджерів і передачі задач.', ru: 'Команда без накладных расходов: двое senior-инженеров, прямая коммуникация с заказчиком, нулевая бюрократия — за архитектуру, код и релиз отвечают те же люди, без прослойки менеджеров и передачи задач.', en: 'A team with zero overhead: two senior engineers, direct client communication, no bureaucracy — the same people own architecture, code and release, with no manager layer and no task handoffs.' },
            ] as Bi[]).map((b, i) => (
